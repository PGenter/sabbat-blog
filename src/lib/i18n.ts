...
const translations = {
  german: {
    ...
    mobileGpsHint: "Hinweis: Auf Mobilgeräten werden GPS-Standortdaten aus Datenschutzgründen oft automatisch aus Fotos entfernt. Falls keine Standortdaten gefunden werden, kannst du den Ort anschließend manuell auf der Karte markieren.",
    pickLocationHint: "Keine GPS-Daten gefunden. Bitte tippe auf die Karte, um den Standort dieser Fotos festzulegen.",
    adjustLocationHint: "Verschiebe den Marker bei Bedarf und bestätige mit \"Übernehmen\".",
    confirmLocation: "Übernehmen",
    hello: "Hallo",
  ...
  spanish: {
    ...
    mobileGpsHint: "Aviso: en dispositivos móviles, los datos de ubicación GPS suelen eliminarse automáticamente de las fotos por motivos de privacidad. Si no se encuentran datos de ubicación, podrás marcar el lugar manualmente en el mapa.",
    pickLocationHint: "No se encontraron datos GPS. Por favor, toca el mapa para indicar la ubicación de estas fotos.",
    adjustLocationHint: "Mueve el marcador si es necesario y confirma con \"Aceptar\".",
    confirmLocation: "Aceptar",
    hello: "Hola",
